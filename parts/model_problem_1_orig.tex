...
The three fields Hu–Washizu principle characterizes the equilibrium of the body by the minimization of the functional $J_{\cell}^{HW}$ with respect to the displacement field $\tensori{u}{}_{\cell} \in \displacementSpaceCell$ verifying $\tensori{u}{}_{\cell} \vert_{\dirichletCell{}} = \dirichletLag$, the displacement gradient field $\tensorii{G}{}_{\cell} \in \gradSpaceCell$, and the first Piola-Kirchoff stress tensor field $\tensorii{P}{}_{\cell} \in \stressSpaceCell$, such that
%
%
%
\begin{equation}

...
\subsection{From the continuous Hu-Washizu Lagrangian to the HDG Lagrangian}
...
% % 
% % 
% Using \eqref{eq_continuity_traction_force_2} and \eqref{eq_grad_displacement_interface}, one can write the internal contribution $L_{\Crown{}, \text{int}}^{HW}$ in $\Crown{}$ as a term depending on the bulk and boundary displacement such that
% %
% % 
% % 
% \begin{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        \frac{1}{\ell}
        \sum_{i,j}
        (\tensoro{u}{}_{\dCell}{}_{i} - \tensoro{u}{}_{\Bulk}{}{}_{i} \vert_{\dBulk}) \tensoro{n}{}_{j} \tensoro{P}{}_{\Crown{}}{}_{ij}
        \\
        = &
        \ell (1 - \frac{\alpha}{2} \ell)
        \int_{\dBulk{}}
...
% The Lagrangian in the interface is given by
% %
% % 
% % 
% \begin{equation}
...
\subsection{Reconstructed gradient and Elliptic projection}

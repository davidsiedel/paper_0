...
Let us consider the equilibrium of a an (hyperelastic) solid body. The reference and current configurations of the body are denoted respectively $\bodyLag$ and $\bodyEul$ with respective boundaries $\dBodyLag$ and $\dBodyEul$.
%
%
%
...
%
%
The three fields Hu–Washizu principle characterizes the equilibrium of the body by the minimization of the following functional with respect to the displacement field $\tensori{u}{} \in U(\bodyLag)$, the displacement gradient field $\tensorii{G} \in G(\bodyLag)$, and the first Piola-Kirchoff stress tensor field $\tensorii{P} \in S(\bodyLag)$
%
%
%
\begin{equation}
...
%
%
where $U(\bodyLag{})$ denotes the space of all kinematically admissible displacement fields in $\bodyLag{}$, $G(\bodyLag{})$ that of all statically admissible displacement gradient fields, and $S(\bodyLag{})$ that of all statically admissible stress fields, and
the trace operator $\cdot \vert_{\partial X}$ denotes the restriction of a function to the boundary domain $\partial X$.
%
%
%

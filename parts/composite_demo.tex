...
% 
% 
Using \eqref{eq_continuity_traction_force} and \eqref{eq_crown_displacement}, one can write the internal contribution $L_{\Crown{}, \text{int}}^{HW}$ in $\Crown{}$ as a term depending on the bulk and boundary displacement such that
%
% 
% 
\begin{equation}
...
Differentiating $L_{\cell}^{HW}$ with respect to each variable, and introducing the \textit{reconstructed traction force} $\tensori{\theta}{}_{\dCell} = \tensorii{P}{}_{\cell} \vert_{\dCell} \cdot \tensori{n}{} + (\beta / h_{\cell}) (\tensori{u}{}_{\dCell} - \tensori{u}{}_{\cell} \vert_{\dCell})$ one obtains the system
% 
% 
%
\begin{subequations}
...
\begin{equation}
    ...
    \begin{aligned}
        ...
        % =
        \delta L_{\cell, \text{int}}^{VW} - \delta L_{\cell, \text{ext}}^{VW}
        =
        0
        % \\

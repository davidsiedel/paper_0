...
consider a partition of the body into elementary subsets called \textit{cells}. Let $\cell$ be
...
In the framework of conforming Galerkin methods, the displacement field is continuous at cells interfaces.
The displacement continuity is broken for discontinuous Galerkin methods, to ensure the continuity of the flux instead.

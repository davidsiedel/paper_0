...
minimizing the energy functional $L_{\cell}$:
%
\begin{equation}
...
$L_{\cell}$, for the displacement field
$\tensori{u}{}_{\cell} \in \displacementSpaceCell$
...
% such that $\cell = \cup_{1 \geq i \geq N} \matI$, the energy $L_{\cell}$ writes as the sum of the contribution in each medium. Extending the notations introduced in Section \ref{sec_model_problem} to any of these media $\matI$,
the problem writes :
% $\forall i$,
...
% On the contrary, if $\bodyLag = \cup_{1 \geq i \geq N} \matI$, is made out of a partition of distinct media $\matI \subset \bodyLag$ with respective energy potentials $\mecPotential{}_{\matI}$, the energy $L_{\bodyLag}$ in $\bodyLag$ writes as the sum of the contribution in each medium :
% %
% \begin{equation}
% \label{eq_hu_washizu_composite}
% \begin{aligned}
...
\begin{equation}
    ...
    \begin{aligned}
        d L_{T}
        = &
        \frac{\partial L_{T}}{\partial \tensori{u}{}_{T}} \delta \tensori{u}{}_{T}
        +
        \frac{\partial L_{T}}{\partial \tensori{u}{}_{\partial T}} \delta \tensori{u}{}_{\partial T}
        =
        0
        \\
        = &
        \int_{T} \tensorii{P}{}_{T} : \nabla \delta \tensori{u}{}_{T}
        +

...
\begin{frontmatter}
  ...
  \begin{abstract}
    ...
    use of approximation spaces based on polynomials of abritrary
    orders.

    From the point of view of numerical performances, the
    elimination of the cell degrees of freedom is mandory to to reduce
    ...
    Avantages and disadvantages of both strategies are discussed.
  ...
  \begin{keyword}
    ...
    Volumetric locking \sep Axisymmetric modelling hypothesis
  \end{keyword}
